...
class ImportProgramRankingFromJoomla2023 extends Command
{
    protected $signature = 'import:program-ranking-2023';
    protected $description = 'Import program ranking 2023 from old Joomla site';

    public function handle()
    {
        $this->info('Начинаем импорт программного рейтинга 2023...');
    ...
    private function parseFullGroupRanking2023(
        int $itemId,
        Group $group,
        int $year
    )
