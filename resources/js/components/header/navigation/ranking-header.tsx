...
type NavItem = {
  href: "/" | "/ranking" | "/program-ranking" | "/website-ranking" | "/methodology" | "/ireg";
  label: string;
  icon: typeof Home;
};
...
const isItemActive = (currentPath: RankingPath, href: NavItem["href"]) => {
  if (href === "/program-ranking") {
    return currentPath === "/program-ranking" || currentPath === "/program-ranking-v2";
  }
...
export default function RankingHeader({
  ...
  const activeItem = useMemo(() => {
    return navItems.find((item) => isItemActive(currentPath, item.href)) ?? navItems[0];
  }, [currentPath]);
    ...
    <>
      <header
        className={cn(
          ...
          solidMode ? "bg-white py-3 shadow-lg shadow-black/5" : "bg-transparent py-5",
          className,
        )}
      >
              ...
              <div className="hidden sm:block">
                <h1
                  className={cn(
                    ...
                    solidMode ? "text-slate-800" : "text-white",
                  )}
                >
                  IQAA Ranking
                </h1>
                <p
                  className={cn(
                    ...
                    solidMode ? "text-slate-400" : "text-blue-300/60",
                  )}
                >
            ...
            <nav className="hidden items-center lg:flex">
              <div
                className={cn(
                  ...
                  solidMode ? "border border-slate-200/80 bg-slate-100" : "glass",
                )}
              >
                {navItems.map((item) => {
