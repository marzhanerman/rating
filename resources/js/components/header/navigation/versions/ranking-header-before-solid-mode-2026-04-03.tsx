...
const navItems: NavItem[] = [
  ...
  { href: "/ranking", label: "Рейтинг вузов", icon: Trophy },
  { href: "/program-ranking", label: "Программный рейтинг", icon: GraduationCap },
  { href: "/website-ranking", label: "Рейтинг сайтов", icon: Globe },
  { href: "/methodology", label: "Методология", icon: BookOpenText },
    ...
    <>
      <header
        className={cn(
          ...
          scrolled ? "bg-white py-3 shadow-lg shadow-black/5" : "bg-transparent py-5",
          className,
        )}
      >
          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex shrink-0 items-center gap-3">
              ...
              <div className="hidden sm:block">
                <h1
                  className={cn(
                    "text-sm font-bold uppercase tracking-wider transition-colors duration-500",
                ...
                <p
                  className={cn(
                    ...
                    scrolled ? "text-slate-400" : "text-blue-300/60",
                  )}
                >
            ...
            <nav className="hidden items-center lg:flex">
              <div
                className={cn(
                  ...
                  scrolled ? "border border-slate-200/80 bg-slate-100" : "glass",
                )}
              >
                {navItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      href={item.href}
                      className={cn(
                        "flex items-center gap-2 whitespace-nowrap rounded-xl px-4 py-2 text-[13px] font-medium transition-all duration-300",
                        isActive
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={cn(
                  ...
                  scrolled ? "bg-slate-100 text-slate-700 hover:bg-slate-200" : "glass text-white hover:bg-white/10",
                )}
      ...
      >
        ...
        <div
          className={cn(
            "absolute right-0 top-0 h-full w-[300px] max-w-[85vw] bg-gradient-to-b from-[#0f172a] to-[#1e293b] shadow-2xl transition-transform duration-500 ease-out",
        ...
        >
          <div className="p-6 pt-20">
            <div className="mb-8 flex items-center gap-3 border-b border-white/10 pb-6">
              ...
              <div>
                <h2 className="text-sm font-bold uppercase tracking-wider text-white">IQAA Ranking</h2>
                <p className="text-[10px] text-blue-300/50">Рейтинг образования</p>
              </div>
            </div>
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive ? "nav-item-active text-white" : "text-blue-100/60 hover:bg-white/5 hover:text-white",
                    )}
