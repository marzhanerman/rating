      ...
      <div className="min-h-screen bg-[#f6f8fc] text-slate-950">
        ...
        <section className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="mb-10 flex w-full flex-wrap gap-3">
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`
          min-h-[56px] px-5 py-3 rounded-2xl text-[13px] font-bold transition-all duration-300 
          border leading-tight whitespace-normal text-center
          sm:flex-1 sm:basis-[calc(50%-0.75rem)] xl:basis-[calc(33.333%-0.75rem)]
          ${isActive
            ...
            <div className="grid md:grid-cols-4 gap-x-12 gap-y-16">
              ...
              {[
                ...
                },
                {
                  ...
                  path: "M12 3a9 9 0 100 18 9 9 0 000-18zm0 0c2.5 0 4.5 4 4.5 9s-2 9-4.5 9m0-18c-2.5 0-4.5 4-4.5 9s2 9 4.5 9M3.3 9h17.4M3.3 15h17.4M9 12l2 2 4-4"
                },
                {
