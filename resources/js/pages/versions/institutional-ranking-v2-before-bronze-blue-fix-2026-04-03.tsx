          ...
          <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
            ...
            {currentCategory ? (
              <div className="mb-8 flex items-center gap-3">
                <div className="inline-flex items-center gap-2 rounded-full bg-blue-600 px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-wider text-white">
            ...
            {filteredUniversities.length > 0 && currentCategory ? (
              <div className="overflow-hidden rounded-2xl border border-gray-200/60 bg-white shadow-xl shadow-gray-200/40">
                <div className="bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-600 px-7 py-5">
