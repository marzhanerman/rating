...
export default function UniversityProfilePage({
  ...
  return (
    <>
      <Head title={`${profile.currentName ?? "РџСЂРѕС„РёР»СЊ РІСѓР·Р°"} | IQAA Ranking`} />
        ...
        <RankingHero
          ...
          content={
            <div className="space-y-8">
              <Link
                href={backHref}
                className="glass inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-white/90 transition-all duration-300 hover:bg-white/15"
              >
                <ArrowLeft className="h-4 w-4" />
                Вернуться к рейтингу
              </Link>

              <div className="inline-flex items-center gap-2 rounded-full glass px-4 py-2 text-[12px] font-semibold uppercase tracking-wider text-blue-200/80">
                <Building2 className="h-4 w-4 text-blue-300" />
                Профиль университета
              </div>

              <h1 className="max-w-4xl text-4xl font-extrabold leading-[1.08] tracking-tight text-white sm:text-5xl lg:text-[3.5rem]">
              ...
              <p className="max-w-2xl text-base leading-relaxed text-blue-100/70 sm:text-lg">
                Здесь собраны текущая позиция, итоговый балл, паспорт вуза и его динамика в институциональном рейтинге IQAA по годам.
              </p>
          ...
          aside={
            <div className="space-y-4 lg:ml-auto lg:max-w-md">
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                <RankingHeroStat label="Текущая позиция" value={`#${profile.currentRank}`} valueClassName="text-3xl" />
                <RankingHeroStat label="Итоговый балл" value={formatScore(profile.currentScore)} valueClassName="text-3xl" />
              </div>

              <RankingHeroPanel className="rounded-[1.75rem] p-5">
                <div className="text-[11px] font-semibold uppercase tracking-[0.16em] text-blue-300/70">Год рейтинга</div>
                <select
            ...
            <aside className="space-y-6 xl:sticky xl:top-6">
              <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                <div className="flex items-center gap-2 text-sm font-medium uppercase tracking-[0.24em] text-blue-700">
                  ...
                  РћР±Р·РѕСЂ РїСЂРѕС„РёР»СЏ
                </div>

                <h2 className="mt-3 text-2xl font-semibold text-slate-950">РљР»СЋС‡РµРІРѕР№ СЃСЂРµР· РїРѕ РІСѓР·Сѓ</h2>
                <p className="mt-3 text-sm leading-6 text-slate-500">
                  РџСЂР°РІР°СЏ РєРѕР»РѕРЅРєР° С‚РµРїРµСЂСЊ СЂР°Р±РѕС‚Р°РµС‚ РєР°Рє РєРѕРјРїР°РєС‚РЅРѕРµ РґРѕСЃСЊРµ: Р·РґРµСЃСЊ СѓРґРѕР±РЅРѕ Р±С‹СЃС‚СЂРѕ РїРѕСЃРјРѕС‚СЂРµС‚СЊ РіРѕРґ, РєР°С‚РµРіРѕСЂРёСЋ Рё
                  РЅРµРґР°РІРЅСЋСЋ РёСЃС‚РѕСЂРёСЋ Р±РµР· РґР»РёРЅРЅРѕРіРѕ СЃРєСЂРѕР»Р»Р°.
                </p>

                <div className="mt-6 space-y-3">
                  <QuickFact label="Р’С‹Р±СЂР°РЅРЅС‹Р№ РіРѕРґ" value={selectedYear ? String(selectedYear) : "РђСЂС…РёРІ"} />
                  <QuickFact label="РљР°С‚РµРіРѕСЂРёСЏ" value={profile.institutionalCategory} />
                  <QuickFact label="Р›СѓС‡С€Р°СЏ РїРѕР·РёС†РёСЏ" value={`#${bestRank}`} />
                  <QuickFact label="Р›РµС‚ РІ СЂРµР№С‚РёРЅРіРµ" value={String(historyRows.length)} />
                </div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  ...
                  >
                    РЎРѕСЃРµРґРё РїРѕ СЂРµР№С‚РёРЅРіСѓ
                  </a>
                </div>
              </div>
              ...
              <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
                <div className="flex items-center gap-2 text-sm font-medium uppercase tracking-[0.24em] text-blue-700">
                  ...
                  РђСЂС…РёРІ СЂРµР№С‚РёРЅРіР°
                </div>

                <h2 className="mt-3 text-2xl font-semibold text-slate-950">РџРѕСЃР»РµРґРЅРёРµ РіРѕРґС‹</h2>
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="text-right">
                          <div className="text-xs uppercase tracking-[0.2em] text-slate-400">Р‘Р°Р»Р»С‹</div>
                ...
                >
                  РџРѕР»РЅР°СЏ С‚Р°Р±Р»РёС†Р° РёСЃС‚РѕСЂРёРё
                  <ChevronRight className="h-4 w-4" />
                </a>
              </div>
            </aside>
          ...
          <section className="mt-10 grid gap-6 lg:grid-cols-[minmax(0,1fr)_380px]">
            <div id="history-table" className="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <div className="flex flex-col gap-3 border-b border-slate-200 pb-6 md:flex-row md:items-end md:justify-between">
                <div>
                  <div className="text-sm font-medium uppercase tracking-[0.24em] text-blue-700">РСЃС‚РѕСЂРёСЏ СЂРµР№С‚РёРЅРіР°</div>
                  <h2 className="mt-2 text-3xl font-semibold text-slate-950">Р”РёРЅР°РјРёРєР° РїРѕ РіРѕРґР°Рј</h2>
                </div>

                <div className="text-sm text-slate-500">
                  Р”РѕСЃС‚СѓРїРЅРѕ Р»РµС‚: <span className="font-semibold text-slate-900">{historyRows.length}</span>
                </div>
              </div>
              ...
              <div className="mt-8 overflow-hidden rounded-[1.5rem] border border-slate-200">
                <div className="grid grid-cols-[120px_120px_minmax(0,1fr)] gap-4 bg-slate-100 px-5 py-4 text-xs font-semibold uppercase tracking-[0.22em] text-slate-500 md:grid-cols-[140px_140px_minmax(0,1fr)] md:px-6">
                  <div>Р“РѕРґ</div>
                  <div>РњРµСЃС‚Рѕ</div>
                  <div>РС‚РѕРіРѕРІС‹Р№ Р±Р°Р»Р»</div>
                </div>
            ...
            <div id="peer-positions" className="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <div className="text-sm font-medium uppercase tracking-[0.24em] text-blue-700">РљРѕРЅС‚РµРєСЃС‚ РєР°С‚РµРіРѕСЂРёРё</div>
              <h2 className="mt-2 text-3xl font-semibold text-slate-950">РЎРѕСЃРµРґРЅРёРµ РїРѕР·РёС†РёРё</h2>
              <p className="mt-4 text-sm leading-6 text-slate-500">
                РЎСЂРµР· РїРѕ РІС‹Р±СЂР°РЅРЅРѕРјСѓ РіРѕРґСѓ РїРѕРєР°Р·С‹РІР°РµС‚ РјРµСЃС‚Рѕ РІСѓР·Р° РІРЅСѓС‚СЂРё СЃРІРѕРµР№ РёРЅСЃС‚РёС‚СѓС†РёРѕРЅР°Р»СЊРЅРѕР№ РєР°С‚РµРіРѕСЂРёРё.
              </p>
              ...
              <div className="mt-6 space-y-3">
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div className="min-w-0">
                          <div className="text-xs uppercase tracking-[0.2em] text-slate-400">РџРѕР·РёС†РёСЏ #{peer.rank}</div>
                          {peerHref ? (
                            <Link
                              href={peerHref}
                            ...
                            >
                              <span className="truncate">{peer.universityName ?? "РЈРЅРёРІРµСЂСЃРёС‚РµС‚ РЅРµ СѓРєР°Р·Р°РЅ"}</span>
                              <ArrowUpRight className="h-4 w-4 shrink-0" />
                            </Link>
                          ) : (
                            <div className="mt-2 text-sm font-semibold text-slate-950">
                              {peer.universityName ?? "РЈРЅРёРІРµСЂСЃРёС‚РµС‚ РЅРµ СѓРєР°Р·Р°РЅ"}
                            </div>
                          )}
                        </div>
                ...
                {peerRatings.length === 0 ? (
                  <div className="rounded-[1.35rem] border border-dashed border-slate-300 bg-slate-50 px-4 py-10 text-center text-sm text-slate-500">
                    Р”Р»СЏ РІС‹Р±СЂР°РЅРЅРѕРіРѕ РіРѕРґР° РЅРµ РЅР°Р№РґРµРЅРѕ РґРѕРїРѕР»РЅРёС‚РµР»СЊРЅС‹С… СЃС‚СЂРѕРє РїРѕ РєР°С‚РµРіРѕСЂРёРё.
                  </div>
                ) : null}
              </div>
            </div>
