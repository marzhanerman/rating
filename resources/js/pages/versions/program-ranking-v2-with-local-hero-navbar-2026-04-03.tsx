...
import ProgramRankingV2Hero from "@/components/program-ranking-v2/program-ranking-v2-hero";
import ProgramRankingV2Navbar from "@/components/program-ranking-v2/program-ranking-v2-navbar";
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        <ProgramRankingV2Navbar />
        <ProgramRankingV2Hero
        ...
        <div id="ranking-section" className="relative overflow-hidden bg-white scroll-mt-24">
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            <div className="mb-12 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <div className="mb-5 inline-flex items-center gap-2 rounded-full bg-blue-600 px-4 py-2 text-[11px] font-bold uppercase tracking-widest text-white shadow-lg shadow-blue-600/30">
                  <Star size={12} fill="currentColor" />
                  {`${TEXT.ratingYear} ${selectedYear}`}
                </div>
                <h2 className="mb-3 text-4xl font-black leading-tight tracking-tight text-gray-900 sm:text-5xl">
                  {TEXT.title}
                </h2>
